---
url: https://www.yuque.com/hollis666/ziravy/xtd0s5
title: ✅Java 中有了基本类型为什么还需要包装类？
date: 2026-01-29 17:15:44
tag: 
...
| ---- | ------- | --------- | --- | ------------------------------------------------------ |
| 布尔型  | boolean | Boolean   | /   | /                                                      |
| 单字符  | byte    | Byte      | 1字节 | -128 到 127                                             |
| 整形   | short   | Short     | 2字节 | -32,768 到 32,767                                       |
...
| 单浮点型 | float   | Float     | 4字节 | 约 -3.4E38 到 3.4E38                                     |
| 双浮点型 | double  | Double    | 8字节 | 约 -1.7E308 到 1.7E308                                   |
...
[✅简单介绍一下JIT优化技术？](https://www.yuque.com/hollis666/ziravy/nkr4ge)

## 接口定义中应该用什么？  

[✅RPC接口返回中，使用基本类型还是包装类？](https://www.yuque.com/hollis666/ziravy/hqm4f0)
